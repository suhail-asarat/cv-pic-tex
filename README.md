...
1. Copy or download `cv.tex`, `cv.sty`, and provide your own profile picture (e.g., `image.jpg`).
2. Open `cv.tex` in your preferred LaTeX editor.
3. Update the `\cvProfilePic`, `\cvHeader`, and subsequent sections with your personal information, work experience, education, etc.
...
4. Click the **Upload** icon (top left of the file tree) and upload the following files from your computer:
   - `cv.tex`
   - `cv.sty`
   - Your profile picture (e.g., `image.jpg`)
